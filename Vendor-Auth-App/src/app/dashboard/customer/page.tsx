      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="backdrop-blur-lg bg-white/10 rounded-2xl shadow-2xl border border-white/20 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <button 
              onClick={() => router.push('/_hidden/dashboard/vendors')}
            ...
            <button 
              onClick={() => router.push('/_hidden/dashboard/events')}
            ...
            <button 
              onClick={() => router.push('/_hidden/dashboard/messages')}
            ...
            <button 
              onClick={() => router.push('/_hidden/dashboard/notifications')}
